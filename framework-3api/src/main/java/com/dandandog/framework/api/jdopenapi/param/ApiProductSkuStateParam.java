...
import com.dandandog.framework.api.jdopenapi.result.ApiProductSkuStateResult;
import lombok.Data;
...
public class ApiProductSkuStateParam extends AbstractAPIRequest<ApiProductSkuStateResult> {
