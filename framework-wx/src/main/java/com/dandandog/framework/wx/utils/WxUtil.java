...
public class WxUtil {
    ...
    public static WxMaSecCheckService getSecCheckService() {
        return getMaService().getSecCheckService();
    }
    ...
    public static EntPayService getQueryEntPay() {
        return getQueryEntPay();
    }
